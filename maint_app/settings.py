"""
Django settings for maint_app project.
...
SECRET_KEY = os.environ.get("DJANGO_SECRET_KEY", "dev-not-for-prod")
...
INSTALLED_APPS = [
    ...
    'apps.portal',
    'apps.accounts.apps.PortalConfig',
...
WSGI_APPLICATION = 'maint_app.wsgi.application'


# Database
# https://docs.djangoproject.com/en/5.2/ref/settings/#databases

DB_HOST = os.getenv("5432", "127.0.0.1")  # was "db"
...
LOGGING = {
    ...
    "loggers": {
        ...
        "django.template": {  # helpful if it’s a template problem
            "handlers": ["console"],
            "level": "ERROR",
            "propagate": False,
        },
